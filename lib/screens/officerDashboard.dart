...
class _OfficerDashboardState extends State<OfficerDashboard> {
  ...
  final List<Widget> _pages = [
    ...
    const _DashboardBody(),       // index 0 - dashboard
    const OfficerActivityList(),  // index 1 - activities
    const ManageKPIPage(),       // index 2 - preachers
    const PaymentPage(),        // index 3 - payment
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: BottomNavigationBar(
          ...
          BottomNavigationBarItem(icon: Icon(Icons.trending_up),activeIcon: Icon(Icons.trending_up), label: 'KPI'),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SingleChildScrollView(
                        ...
                        child: Row(
                          children: [
                            _buildHeaderStatCard('Preachers', _totalPreachers,Colors.white),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Active', _activePreachers,Colors.white),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Activities', activities.length,Colors.white),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Assigned', assignedCount,Colors.blue.shade200),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Checked-In', checkedInCount,Colors.cyan.shade200),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Check-In Missed', checkInMissedCount,Colors.deepOrange.shade200),
                            const SizedBox(width: 10),
                             _buildHeaderStatCard('Pending Late Check In', pendingOfficerReviewCount,Colors.purple.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Pending Absence Review', pendingAbsenceReviewCount,Colors.purple.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Pending Submission', pendingReportCount,Colors.orange.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Pending Review', pendingCount,Colors.orange.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Pending Report', pendingReportCount,Colors.amber.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Absent', absentCount,Colors.redAccent.shade200),
                            const SizedBox(width: 10),
                            _buildHeaderStatCard('Approved', approvedCount,Colors.green.shade200),
                            const SizedBox(width: 10),                       
                            _buildHeaderStatCard('Rejected', rejectedCount,Colors.red.shade200),
              ...
              child: ElevatedButton.icon(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  elevation: 0,
                    ...
                    (activity.status.toLowerCase() == 'pending_officer_review') )...[
