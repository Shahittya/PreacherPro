...
class ViewReportOfficerScreen extends StatefulWidget {
  final ActivityData activity;
  const ViewReportOfficerScreen({super.key, required this.activity});

  @override
  State<ViewReportOfficerScreen> createState() => _ViewReportOfficerScreenState();
}

class _ViewReportOfficerScreenState extends State<ViewReportOfficerScreen> {
  bool _loading = true;
